...
//console.log(`${spacecraftName} took ${daysToMars} to arrive to Mars`);
...
//console.log(`${spacecraftName} took ${getDaysToLocation(kilometersToTheMoon)} to arrive to the Moon`);
